...
def build_demo_leads():
    ...
    seeds = [
        ...
        ("Maria Esposito", "maria.esposito@email.it", "+39 320 5567890", "Salerno", "appartamento", 70, "premium", 1, 2, "Entro 3 mesi", "Classico elegante", "social", "qualificato", "Vincenzo Bianco", 1, False),
        ("Giovanni Coppola", "g.coppola@email.it", "+39 339 7741122", "Pozzuoli", "ufficio", 120, "premium", 2, 0, "Entro 3 mesi", "Industrial loft", "referral", "sopralluogo_fissato", "Vincenzo Bianco", 2, True),
        ("Anna Ferrara", "anna.ferrara@email.it", "+39 347 3398765", "Casoria", "appartamento", 85, "premium", 2, 2, "Entro 6 mesi", "Moderno minimal", "landing", "sopralluogo_fatto", "Salvatore Bianco", 4, False),
        ("Salvatore Greco", "s.greco@email.it", "+39 334 2218899", "Aversa", "negozio", 60, "essenziale", 1, 0, "Subito", "Industrial loft", "landing", "preventivo_inviato", "Vincenzo Bianco", 7, False),
        ("Carla Rizzo", "carla.rizzo@email.it", "+39 366 5543210", "Napoli", "appartamento", 110, "luxury", 2, 3, "Entro 3 mesi", "Contemporaneo caldo", "social", "preventivo_inviato", "Vincenzo Bianco", 12, True),
        ("Paolo Marino", "paolo.marino@email.it", "+39 329 8876543", "Benevento", "villa", 200, "luxury", 3, 5, "Sto valutando", "Classico elegante", "referral", "in_trattativa", "Salvatore Bianco", 9, True),
        ("Roberta Conti", "roberta.conti@email.it", "+39 351 1122334", "Avellino", "appartamento", 75, "premium", 1, 2, "Entro 6 mesi", "Moderno minimal", "landing", "follow_up", "Vincenzo Bianco", 6, False),
        ("Davide Galli", "davide.galli@email.it", "+39 340 9988776", "Giugliano in Campania", "capannone", 350, "essenziale", 1, 0, "Entro 3 mesi", "Industrial loft", "landing", "chiuso_vinto", "Salvatore Bianco", 20, False),
        ("Elena Bruno", "elena.bruno@email.it", "+39 333 4455667", "Castellammare di Stabia", "appartamento", 65, "premium", 1, 2, "Sto valutando", "Classico elegante", "social", "chiuso_perso", "Vincenzo Bianco", 28, False),
...
def build_demo_cantieri():
    ...
    return [
        {"cliente": "Davide Galli", "indirizzo": "Via Roma 45, Giugliano in Campania",
         ...
         "capocantiere": "Salvatore Bianco", "importo": 142000, "criticita": None,
        ...
        {"cliente": "Studio Legale Marino", "indirizzo": "Corso Umberto 12, Napoli",
         ...
         "capocantiere": "Salvatore Bianco", "importo": 98000, "criticita": "Ritardo consegna infissi (+5gg)",
        ...
        {"cliente": "Famiglia Sorrentino", "indirizzo": "Via Posillipo 88, Napoli",
         ...
         "capocantiere": "Salvatore Bianco", "importo": 215000, "criticita": None,
         "fasi": [{"nome": "Demolizioni", "stato": "completata"}, {"nome": "Impianti", "stato": "completata"},
